          ...
          <div>
            ...
            <address className="not-italic">
              ...
              <p className="flex items-center">
                ...
                <span className="text-gray-300">info@ayurcare.com</span>
              </p>
            </address>
          </div>
        </div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            <div className="md:w-1/2 mb-6 md:mb-0">
              ...
              <p className="text-gray-400">
                Stay updated with our latest undertakings and ayurvedic
                insights.
              </p>
            </div>
            <div className="md:w-1/2">
              <form className="flex flex-col sm:flex-row">
                <input
                  ...
                  className="bg-gray-900 text-white px-4 py-2 rounded-l sm:rounded-r-none mb-2 sm:mb-0 focus:outline-none focus:ring-2 focus:ring-green-500"
                  required
                />
                <button
                  type="submit"
                  className="bg-gradient-to-r from-green-600 to-emerald-500 text-white px-6 py-2 rounded-r sm:rounded-l-none hover:from-green-700 hover:to-emerald-600 transition-colors duration-300 cursor-pointer"
                >
                  Subscribe
                </button>
              </form>
