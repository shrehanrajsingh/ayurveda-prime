...
export default function Signup() {
  return (
    <>
      <div
        className="w-full min-h-screen flex justify-center items-center px-4 sm:px-6 lg:px-8 py-8"
        style={{
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  type="text"
                  id="firstName"
                  className="w-full px-3 md:px-4 py-2 md:py-3 bg-white/20 border border-emerald-300/30 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent placeholder-emerald-200/50 text-white transition-all duration-200"
                  placeholder="John"
                  required
                />
              </div>
